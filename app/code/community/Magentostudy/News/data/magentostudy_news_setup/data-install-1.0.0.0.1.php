...
$dataRows = array(
	...
	'content' => '<p>In October, Magento launched the beta version of the Magento Certified Developer exam. Dozens of experienced Magento developers flocked to the X.commerce Innovate 2011 Conference &ndash; and to
	several other beta exam locations around the world &ndash; to take the exam. Many of them earned passing grades, becoming the world&rsquo;s first Magento Certified Developers.<br /><br />With the successful beta behind us, we are excited to announce the global launch of our Certification program. <strong>Now, developers can take the Magento Certified Developer exam at over	5,000 Prometric Testing Centers worldwide.</strong><br /><br />Find out how	to register, prepare for, and take the certification exam on the Magento U Certification website.<br /><br /><strong>What you should know about Magento Developer Certification:</strong><br /><br /></p>
	<ul> <li>Magento Developer Certification is the first and only Magento-sponsored and approved professional certification program.</li> <li>Magento Developer Certification Exams were developed by a team of experts
	from across the Magento ecosystem to accurately test and verify real-world development skills.</li>
