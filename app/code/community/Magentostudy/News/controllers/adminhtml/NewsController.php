...
class Magentostudy_News_adminhtml_NewsController extends Mage_adminhtml_Controller_Action
{
	...
	*/
	protected function _initAction()
	{
		...
		->_addBreadcrumb(Mage::helper('magentostudy_news')->__('News'),	Mage::helper('magentostudy_news')->__('News'))
		->_addBreadcrumb(Mage::helper('magentostudy_news')->__('Manage News'),Mage::helper('magentostudy_news')->__('Manage News'));
		return $this;
	}
	/**
	* Index action
	...
	public function deleteAction()
	{
		...
		if ($itemId) {
			try {
				...
				$this->_getSession()->addException($e,Mage::helper('magentostudy_news')->__('An error occurred while deleting the news item.'));
			}
		}
		// go to grid
		$this->_redirect('*/*/');
